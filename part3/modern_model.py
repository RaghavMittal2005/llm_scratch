...
sys.path.insert(0, parent_dir)#adds parent folder in search path
...
class GPTModern(nn.Module):
    def __init__(self, vocab_size: int = 256, block_size: int = 256,
        ...
        self.blocks = nn.ModuleList([
            Transformerblock(n_embd, n_head, dropout, use_rmsnorm, use_swiglu, rope, max_pos, sliding_window, attention_sink, n_kv_head)
